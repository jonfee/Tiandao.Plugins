...
using CancelEventHandler = Tiandao.ComponentModel.CancelEventHandler;
...
namespace Tiandao.Plugins
{
    public static class Application
    {
		...
		private static void InitializeGlobalModules(PluginApplicationContext context)
		{
			...
			{
				var modules = configuration.GetOptionObject("/modules") as Tiandao.Options.Configuration.ModuleElementCollection;

				if(modules != null && modules.Count > 0)
				{
					foreach(Tiandao.Options.Configuration.ModuleElement module in modules)
					{
